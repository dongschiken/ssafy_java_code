...
import com.ssafy.ws.day04.step02.Person;
...
public class PersonTest {
	...
	public static void main(String[] args) {
		...
		person1.showInformation();
		System.out.println("기본 생성자를 주척 처리하면 The ____ Person() is ____ 메시지가 출력됩니다.");
