...
public class Person {
	...
	public Person(/* Person this, */String name, int age, double height, String hobby) {
		this.name = name;
		this.age = age;
		this.height = height;
		this.hobby = hobby;
	...
	public void showInformation() {
		...
		System.out.println("저의 키는 "+ this.height +"입니다." );
	...
	public static void main(String[] args) {
		...
		double heigth = 170.0;
		String hobby = "맛집";
		Person p1 = new Person(name, age, heigth, hobby);
