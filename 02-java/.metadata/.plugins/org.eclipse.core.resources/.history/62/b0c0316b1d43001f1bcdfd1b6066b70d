package com.ssafy.ws.day02.step01;
...
public class OneDimensionalArray {
	...
	public static void main(String[] args) {
		...
		System.out.println("인덱스 범위를 벗어나는 경우, ArrayIndexOutOfBoundsException 이 발생합니다.");
		...
		System.out.println("grade3의 길이는 " + grade3.length + "입니다.");
